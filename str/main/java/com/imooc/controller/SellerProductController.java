...
//map
    ...
    public ModelAndView onSale(@RequestParam("productId") String productId, Map<String, Object> map) {
        try {
            productService.onSale(productId);//上架
...
//    @CachePut(cacheNames = "product", key = "123")//与Cacheable不同，他每次都会访问方法，在存到redis中
    //redis缓存
    @CacheEvict(cacheNames = "product", allEntries = true, beforeInvocation = true)//@CacheEvict在访问这个方法之后，会删掉缓存
